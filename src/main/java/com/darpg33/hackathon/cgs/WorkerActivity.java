...
public class WorkerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_dashboard, R.id.nav_worker_home,
                R.id.nav_sign_out)
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_dashboard: {
                Log.d(TAG, "onNavigationItemSelected: nav_dashboard ");
                navController.navigate(R.id.nav_dashboard);
                closeDrawer();
                return true;
            }
            case R.id.nav_worker_home: {
                Log.d(TAG, "onNavigationItemSelected: nav_worker_home ");
    ...
    private void setDrawerHeader() {
        ...
        final TextView department = navigationView.getHeaderView(0).findViewById(R.id.drawer_user_department);
