package com.darpg33.hackathon.cgs.ui.department.search;
...
public class DepartmentSearchFragment extends Fragment implements RequestsAdapter.GrievanceOnClickListener, TextWatcher {


    private static final String TAG = "DepartmentSearchFragmen";


    //vars
    private ArrayList<Grievance> mGrievances = new ArrayList<>();
    private RequestsAdapter mRequestsAdapter;
    private DepartmentSearchViewModel departmentSearchViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        departmentSearchViewModel = ViewModelProviders.of(this).get(DepartmentSearchViewModel.class);
        setupRecyclerView();
        mSearchText.addTextChangedListener(this);

        departmentSearchViewModel.getUserDepartment().observe(this, new Observer<String>() {
            @Override
    ...
    public void onTextChanged(final CharSequence searchText, int start, int before, int count) {
        ...
        if (mUserDepartment != null) {
            departmentSearchViewModel.getGrievances(String.valueOf(searchText), mUserDepartment).observe(this, new Observer<ArrayList<Grievance>>() {
                @Override
