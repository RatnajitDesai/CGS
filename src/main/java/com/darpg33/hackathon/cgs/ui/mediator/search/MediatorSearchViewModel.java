...
public class MediatorSearchViewModel extends ViewModel {


    private static final String TAG = "MediatorSearchViewModel";


    public MutableLiveData<ArrayList<Grievance>> getGrievances(final String queryText) {
